...
DetectObjectDisp::DetectObjectDisp(std::string name) : Module(name){
...
DetectObjectDisp::~DetectObjectDisp(){
...
void DetectObjectDisp::setParam(float simthres, float hordispthres, float verdispthres, unsigned int opmode) {
...
void DetectObjectDisp::extractinterestregions() {
...
void DetectObjectDisp::computegabordescriptors() {
...
unsigned int DetectObjectDisp::compareleftright() {
...
bool DetectObjectDisp::checkcondition(unsigned int points) {
//	m_count = m_count + 1;
...
/*
void DetectObjectDisp::calculatesizeL()
{
...
void DetectObjectDisp::calculatesizeR()
{
...
/*
void *DetectObjectDisp::computeleft(void* ptr) {
	DetectObjectDisp *obj = reinterpret_cast<DetectObjectDisp*>(ptr);
	for(;;) {
...
void *DetectObjectDisp::computeright(void* ptr) {
	DetectObjectDisp *obj = reinterpret_cast<DetectObjectDisp*>(ptr);
	for(;;) {
		// Blocks the calling thread until the specified condition is signalled (pthread_cond_signal() or pthread_cond_broadcast())
...
void DetectObjectDisp::drawDisparity() {
...
void DetectObjectDisp::computeVariance() {
...
void DetectObjectDisp::computeleftnothread() {
	// Extract interest points from the gray image
...
void DetectObjectDisp::computerightnothread() {
	// Extract interest points from the gray image
