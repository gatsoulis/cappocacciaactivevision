#ifndef DetectObjectDisp_H
#define DetectObjectDisp_H
...
//! class DetectObjectDisp  -- Module for detecting presence of an object in a scene based on stereo (depth) information
/*! class DetectObjectDisp  -- Module for detecting presence of an object in a scene based on stereo (depth) information
    revised 03/2006 by Hyundo Kim
*/
	class DetectObjectDisp : public Module  {
		public: 
			...
			//! DetectObjectDisp(std::string name="DetectObjectDisp")  -- the standard constructor
			/*! DetectObjectDisp(std::string name="DetectObjectDisp")  -- the standard constructor */
			DetectObjectDisp(std::string name="DetectObjectDisp");

			//! ~DetectObjectDisp()  -- the destructor
			/*! ~DetectObjectDisp()  -- the destructor */
			~DetectObjectDisp();

			void setParam(float simthres = 0.94, float hordispthres = 4.0, float verdispthres = 19.0, unsigned int opmode = EXHAUSTIVE);
