...
//	captureR = cvCreateFileCapture("/media/Dati/Testing/Video/right.avi");
	...
	//captureL = cvCreateFileCapture("/media/Dati/project_open_cv/openbook/ex3/19.avi");
	//captureR = cvCreateFileCapture("/media/Dati/project_open_cv/openbook/ex3/19.avi");
