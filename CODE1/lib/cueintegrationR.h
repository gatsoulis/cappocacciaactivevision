...
#ifndef CueIntegrationR_H
#define CueIntegrationR_H
...
#define USE_THREADS
	...
	class CueIntegrationR: public Module  {

	//private:
		//typedef enum {RELIABILITY = 0, QUALITY = 1} dataType;

	public: 
		CueIntegrationR(std::string name = "CueIntegrationR");
		~CueIntegrationR();
		...
		//OutputConnector<CvPoint*> cvpointOutR;
