#ifndef DetectSavedObject_H
#define DetectSavedObject_H
...
*/
	class DetectSavedObject : public Module  {
		public: 
			...
			/*! DetectObject(std::string name="DetectObject")  -- the standard constructor */
			DetectSavedObject(std::string name="DetectSavedObject");
...
//end
			...
			InputConnector<CVImage*> cvCameraGrayImageIn;
			InputConnector<CVImage*> cvDatabaseGrayImageIn;
